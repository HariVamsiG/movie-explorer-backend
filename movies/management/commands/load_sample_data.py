...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        movies_data = [
            ...
            {'title': 'Inception', 'release_year': 2010, 'director': 'Christopher Nolan', 'rating': 8.8, 'duration': 148, 'plot': 'A thief who steals corporate secrets through dream-sharing technology is given the inverse task of planting an idea into the mind of a C.E.O.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&h=450&fit=crop', 'genres': ['Sci-Fi', 'Action', 'Thriller'], 'actors': ['Leonardo DiCaprio', 'Marion Cotillard']},
            {'title': 'The Dark Knight', 'release_year': 2008, 'director': 'Christopher Nolan', 'rating': 9.0, 'duration': 152, 'plot': 'When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman must accept one of the greatest psychological and physical tests.', 'poster_url': 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1509347528160-9329d33b2588?w=800&h=450&fit=crop', 'genres': ['Action', 'Crime', 'Drama'], 'actors': ['Christian Bale']},
            {'title': 'Interstellar', 'release_year': 2014, 'director': 'Christopher Nolan', 'rating': 8.6, 'duration': 169, 'plot': 'A team of explorers travel through a wormhole in space in an attempt to ensure humanity survival.', 'poster_url': 'https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1446776877081-d282a0f896e2?w=800&h=450&fit=crop', 'genres': ['Sci-Fi', 'Drama', 'Adventure'], 'actors': ['Matthew McConaughey', 'Anne Hathaway']},
            {'title': 'Dunkirk', 'release_year': 2017, 'director': 'Christopher Nolan', 'rating': 7.8, 'duration': 106, 'plot': 'Allied soldiers from Belgium, the British Commonwealth and Empire, and France are surrounded by the German Army and evacuated during a fierce battle in World War II.', 'poster_url': 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=800&h=450&fit=crop', 'genres': ['War', 'Drama'], 'actors': ['Tom Hanks']},
            {'title': 'Tenet', 'release_year': 2020, 'director': 'Christopher Nolan', 'rating': 7.3, 'duration': 150, 'plot': 'Armed with only one word, Tenet, and fighting for the survival of the entire world, a Protagonist journeys through a twilight world of international espionage.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Sci-Fi', 'Action', 'Thriller'], 'actors': ['Christian Bale']},
            
            # Denis Villeneuve Films
            {'title': 'Blade Runner 2049', 'release_year': 2017, 'director': 'Denis Villeneuve', 'rating': 8.0, 'duration': 164, 'plot': 'Young Blade Runner K discovers a long-buried secret that has the potential to plunge what is left of society into chaos.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Sci-Fi', 'Drama', 'Thriller'], 'actors': ['Ryan Gosling', 'Harrison Ford']},
            {'title': 'Dune', 'release_year': 2021, 'director': 'Denis Villeneuve', 'rating': 8.0, 'duration': 155, 'plot': 'Feature adaptation of Frank Herbert science fiction novel about the son of a noble family entrusted with the protection of the most valuable asset.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&h=450&fit=crop', 'genres': ['Sci-Fi', 'Adventure', 'Drama'], 'actors': ['Timothée Chalamet', 'Zendaya', 'Oscar Isaac']},
            {'title': 'Arrival', 'release_year': 2016, 'director': 'Denis Villeneuve', 'rating': 7.9, 'duration': 116, 'plot': 'A linguist works with the military to communicate with alien lifeforms after twelve mysterious spacecraft appear around the world.', 'poster_url': 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1509347528160-9329d33b2588?w=800&h=450&fit=crop', 'genres': ['Sci-Fi', 'Drama', 'Mystery'], 'actors': ['Amy Adams']},
            
            # Quentin Tarantino Films
            {'title': 'Pulp Fiction', 'release_year': 1994, 'director': 'Quentin Tarantino', 'rating': 8.9, 'duration': 154, 'plot': 'The lives of two mob hitmen, a boxer, a gangster and his wife intertwine in four tales of violence and redemption.', 'poster_url': 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=800&h=450&fit=crop', 'genres': ['Crime', 'Drama'], 'actors': ['Samuel L. Jackson', 'Brad Pitt']},
            {'title': 'Django Unchained', 'release_year': 2012, 'director': 'Quentin Tarantino', 'rating': 8.4, 'duration': 165, 'plot': 'With the help of a German bounty-hunter, a freed slave sets out to rescue his wife from a brutal plantation owner.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=800&h=450&fit=crop', 'genres': ['Western', 'Drama'], 'actors': ['Leonardo DiCaprio']},
            {'title': 'Kill Bill: Vol. 1', 'release_year': 2003, 'director': 'Quentin Tarantino', 'rating': 8.2, 'duration': 111, 'plot': 'After awakening from a four-year coma, a former assassin wreaks vengeance on the team of assassins who betrayed her.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Action', 'Crime', 'Thriller'], 'actors': ['Scarlett Johansson']},
            {'title': 'Once Upon a Time in Hollywood', 'release_year': 2019, 'director': 'Quentin Tarantino', 'rating': 7.6, 'duration': 161, 'plot': 'A faded television actor and his stunt double strive to achieve fame and success in the final years of Hollywood Golden Age in 1969 Los Angeles.', 'poster_url': 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=800&h=450&fit=crop', 'genres': ['Comedy', 'Drama'], 'actors': ['Leonardo DiCaprio', 'Brad Pitt', 'Margot Robbie']},
            
            # Martin Scorsese Films
            {'title': 'Goodfellas', 'release_year': 1990, 'director': 'Martin Scorsese', 'rating': 8.7, 'duration': 146, 'plot': 'The story of Henry Hill and his life in the mob, covering his relationship with his wife Karen Hill and his mob partners.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=800&h=450&fit=crop', 'genres': ['Crime', 'Drama'], 'actors': ['Robert De Niro']},
            {'title': 'The Wolf of Wall Street', 'release_year': 2013, 'director': 'Martin Scorsese', 'rating': 8.2, 'duration': 180, 'plot': 'Based on the true story of Jordan Belfort, from his rise to a wealthy stock-broker living the high life to his fall involving crime, corruption and the federal government.', 'poster_url': 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=800&h=450&fit=crop', 'genres': ['Biography', 'Crime', 'Drama'], 'actors': ['Leonardo DiCaprio', 'Margot Robbie']},
            {'title': 'The Departed', 'release_year': 2006, 'director': 'Martin Scorsese', 'rating': 8.5, 'duration': 151, 'plot': 'An undercover cop and a police informant play a cat and mouse game with each other as they attempt to find out each other identity.', 'poster_url': 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1509347528160-9329d33b2588?w=800&h=450&fit=crop', 'genres': ['Crime', 'Drama', 'Thriller'], 'actors': ['Leonardo DiCaprio']},
            {'title': 'Taxi Driver', 'release_year': 1976, 'director': 'Martin Scorsese', 'rating': 8.2, 'duration': 114, 'plot': 'A mentally unstable veteran works as a nighttime taxi driver in New York City, where the perceived decadence and sleaze fuels his urge for violent action.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Crime', 'Drama'], 'actors': ['Robert De Niro']},
            
            # David Fincher Films
            {'title': 'Fight Club', 'release_year': 1999, 'director': 'David Fincher', 'rating': 8.8, 'duration': 139, 'plot': 'An insomniac office worker and a devil-may-care soap maker form an underground fight club that evolves into an anarchist organization.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Drama'], 'actors': ['Brad Pitt']},
            {'title': 'The Social Network', 'release_year': 2010, 'director': 'David Fincher', 'rating': 7.7, 'duration': 120, 'plot': 'As Harvard student Mark Zuckerberg creates the social networking site that would become known as Facebook.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&h=450&fit=crop', 'genres': ['Biography', 'Drama'], 'actors': ['Adam Driver']},
            {'title': 'Gone Girl', 'release_year': 2014, 'director': 'David Fincher', 'rating': 8.1, 'duration': 149, 'plot': 'With his wife disappearance having become the focus of an intense media circus, a man sees the spotlight turned on him.', 'poster_url': 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=800&h=450&fit=crop', 'genres': ['Drama', 'Mystery', 'Thriller'], 'actors': ['Scarlett Johansson']},
            {'title': 'Se7en', 'release_year': 1995, 'director': 'David Fincher', 'rating': 8.6, 'duration': 127, 'plot': 'Two detectives, a rookie and a veteran, hunt a serial killer who uses the seven deadly sins as his motives.', 'poster_url': 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1509347528160-9329d33b2588?w=800&h=450&fit=crop', 'genres': ['Crime', 'Drama', 'Mystery'], 'actors': ['Brad Pitt']},
            
            # Steven Spielberg Films
            {'title': 'Schindler\'s List', 'release_year': 1993, 'director': 'Steven Spielberg', 'rating': 9.0, 'duration': 195, 'plot': 'In German-occupied Poland during World War II, industrialist Oskar Schindler gradually becomes concerned for his Jewish workforce after witnessing their persecution by the Nazis.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&h=450&fit=crop', 'genres': ['Biography', 'Drama', 'War'], 'actors': ['Tom Hanks']},
            {'title': 'Saving Private Ryan', 'release_year': 1998, 'director': 'Steven Spielberg', 'rating': 8.6, 'duration': 169, 'plot': 'Following the Normandy Landings, a group of U.S. soldiers go behind enemy lines to retrieve a paratrooper whose brothers have been killed in action.', 'poster_url': 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=800&h=450&fit=crop', 'genres': ['Drama', 'War'], 'actors': ['Tom Hanks']},
            {'title': 'Jurassic Park', 'release_year': 1993, 'director': 'Steven Spielberg', 'rating': 8.1, 'duration': 127, 'plot': 'A pragmatic paleontologist touring an almost complete theme park on an island in Central America is tasked with protecting a couple of kids after a power failure causes the park\'s cloned dinosaurs to run loose.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Adventure', 'Sci-Fi', 'Thriller'], 'actors': ['Harrison Ford']},
            
            # Ridley Scott Films
            {'title': 'Gladiator', 'release_year': 2000, 'director': 'Ridley Scott', 'rating': 8.5, 'duration': 155, 'plot': 'A former Roman General sets out to exact vengeance against the corrupt emperor who murdered his family and sent him into slavery.', 'poster_url': 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1509347528160-9329d33b2588?w=800&h=450&fit=crop', 'genres': ['Action', 'Adventure', 'Drama'], 'actors': ['Harrison Ford']},
            {'title': 'Alien', 'release_year': 1979, 'director': 'Ridley Scott', 'rating': 8.4, 'duration': 117, 'plot': 'The crew of a commercial spacecraft encounter a deadly lifeform after investigating an unknown transmission.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Horror', 'Sci-Fi'], 'actors': ['Scarlett Johansson']},
            {'title': 'Blade Runner', 'release_year': 1982, 'director': 'Ridley Scott', 'rating': 8.1, 'duration': 117, 'plot': 'A blade runner must pursue and terminate four replicants who stole a ship in space, and have returned to the earth seeking their creator.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&h=450&fit=crop', 'genres': ['Sci-Fi', 'Thriller'], 'actors': ['Harrison Ford']},
            
            # James Cameron Films
            {'title': 'Titanic', 'release_year': 1997, 'director': 'James Cameron', 'rating': 7.8, 'duration': 194, 'plot': 'A seventeen-year-old aristocrat falls in love with a kind but poor artist aboard the luxurious, ill-fated R.M.S. Titanic.', 'poster_url': 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=800&h=450&fit=crop', 'genres': ['Drama', 'Romance'], 'actors': ['Leonardo DiCaprio']},
            {'title': 'Avatar', 'release_year': 2009, 'director': 'James Cameron', 'rating': 7.8, 'duration': 162, 'plot': 'A paraplegic Marine dispatched to the moon Pandora on a unique mission becomes torn between following his orders and protecting the world he feels is his home.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Action', 'Adventure', 'Fantasy'], 'actors': ['Zendaya']},
            {'title': 'Terminator 2: Judgment Day', 'release_year': 1991, 'director': 'James Cameron', 'rating': 8.6, 'duration': 137, 'plot': 'A cyborg, identical to the one who failed to kill Sarah Connor, must now protect her teenage son John Connor from a more advanced and powerful cyborg.', 'poster_url': 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1509347528160-9329d33b2588?w=800&h=450&fit=crop', 'genres': ['Action', 'Sci-Fi'], 'actors': ['Christian Bale']},
            
            # Peter Jackson Films
            {'title': 'The Lord of the Rings: The Fellowship of the Ring', 'release_year': 2001, 'director': 'Peter Jackson', 'rating': 8.8, 'duration': 178, 'plot': 'A meek Hobbit from the Shire and eight companions set out on a journey to destroy the powerful One Ring and save Middle-earth from the Dark Lord Sauron.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&h=450&fit=crop', 'genres': ['Adventure', 'Drama', 'Fantasy'], 'actors': ['Oscar Isaac']},
            {'title': 'The Lord of the Rings: The Return of the King', 'release_year': 2003, 'director': 'Peter Jackson', 'rating': 9.0, 'duration': 201, 'plot': 'Gandalf and Aragorn lead the World of Men against Sauron army to draw his gaze from Frodo and Sam as they approach Mount Doom with the One Ring.', 'poster_url': 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=800&h=450&fit=crop', 'genres': ['Adventure', 'Drama', 'Fantasy'], 'actors': ['Oscar Isaac']},
            
            # Coen Brothers Films
            {'title': 'No Country for Old Men', 'release_year': 2007, 'director': 'Coen Brothers', 'rating': 8.1, 'duration': 122, 'plot': 'Violence and mayhem ensue after a hunter stumbles upon a drug deal gone wrong and more than two million dollars in cash near the Rio Grande.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Crime', 'Drama', 'Thriller'], 'actors': ['Tommy Lee Jones']},
            {'title': 'Fargo', 'release_year': 1996, 'director': 'Coen Brothers', 'rating': 8.1, 'duration': 98, 'plot': 'Jerry Lundegaard, a car salesman in Minneapolis, has gotten himself into debt and is so desperate for money that he hires two thugs to kidnap his own wife.', 'poster_url': 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1509347528160-9329d33b2588?w=800&h=450&fit=crop', 'genres': ['Crime', 'Drama', 'Thriller'], 'actors': ['Frances McDormand']},
            
            # Paul Thomas Anderson Films
            {'title': 'There Will Be Blood', 'release_year': 2007, 'director': 'Paul Thomas Anderson', 'rating': 8.2, 'duration': 158, 'plot': 'A story of family, religion, hatred, oil and madness, focusing on a turn-of-the-century prospector in the early days of the business.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&h=450&fit=crop', 'genres': ['Drama'], 'actors': ['Daniel Day-Lewis']},
            
            # Wes Anderson Films
            {'title': 'The Grand Budapest Hotel', 'release_year': 2014, 'director': 'Wes Anderson', 'rating': 8.1, 'duration': 99, 'plot': 'A writer encounters the owner of an aging high-class hotel, who tells him of his early years serving as a lobby boy in the hotel\'s glorious years under an exceptional concierge.', 'poster_url': 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=800&h=450&fit=crop', 'genres': ['Adventure', 'Comedy', 'Crime'], 'actors': ['Ralph Fiennes']},
            
            # Jordan Peele Films
            {'title': 'Get Out', 'release_year': 2017, 'director': 'Jordan Peele', 'rating': 7.7, 'duration': 104, 'plot': 'A young African-American visits his white girlfriend\'s parents for the weekend, where his simmering uneasiness about their reception of him eventually reaches a boiling point.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Horror', 'Mystery', 'Thriller'], 'actors': ['Daniel Kaluuya']},
            {'title': 'Us', 'release_year': 2019, 'director': 'Jordan Peele', 'rating': 6.8, 'duration': 116, 'plot': 'A family\'s serene beach vacation turns to chaos when their doppelgängers appear and begin to terrorize them.', 'poster_url': 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1509347528160-9329d33b2588?w=800&h=450&fit=crop', 'genres': ['Horror', 'Mystery', 'Thriller'], 'actors': ['Lupita Nyong\'o']},
            
            # Greta Gerwig Films
            {'title': 'Lady Bird', 'release_year': 2017, 'director': 'Greta Gerwig', 'rating': 7.4, 'duration': 94, 'plot': 'In 2002, an artistically inclined seventeen-year-old girl comes of age in Sacramento, California.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&h=450&fit=crop', 'genres': ['Comedy', 'Drama'], 'actors': ['Saoirse Ronan']},
            {'title': 'Little Women', 'release_year': 2019, 'director': 'Greta Gerwig', 'rating': 7.8, 'duration': 135, 'plot': 'Jo March reflects back and forth on her life, telling the beloved story of the March sisters - four young women, each determined to live life on her own terms.', 'poster_url': 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=800&h=450&fit=crop', 'genres': ['Drama', 'Romance'], 'actors': ['Saoirse Ronan', 'Timothée Chalamet']},
            
            # Rian Johnson Films
            {'title': 'Knives Out', 'release_year': 2019, 'director': 'Rian Johnson', 'rating': 7.9, 'duration': 130, 'plot': 'A detective investigates the death of a patriarch of an eccentric, combative family.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Comedy', 'Crime', 'Drama'], 'actors': ['Daniel Craig']},
            
            # Francis Ford Coppola Films
            {'title': 'The Godfather', 'release_year': 1972, 'director': 'Francis Ford Coppola', 'rating': 9.2, 'duration': 175, 'plot': 'The aging patriarch of an organized crime dynasty in postwar New York City transfers control of his clandestine empire to his reluctant youngest son.', 'poster_url': 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1509347528160-9329d33b2588?w=800&h=450&fit=crop', 'genres': ['Crime', 'Drama'], 'actors': ['Marlon Brando']},
            {'title': 'The Godfather Part II', 'release_year': 1974, 'director': 'Francis Ford Coppola', 'rating': 9.0, 'duration': 202, 'plot': 'The early life and career of Vito Corleone in 1920s New York City is portrayed, while his son, Michael, expands and tightens his grip on the family crime syndicate.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&h=450&fit=crop', 'genres': ['Crime', 'Drama'], 'actors': ['Al Pacino', 'Robert De Niro']},
            {'title': 'Apocalypse Now', 'release_year': 1979, 'director': 'Francis Ford Coppola', 'rating': 8.4, 'duration': 147, 'plot': 'A U.S. Army officer serving in Vietnam is tasked with assassinating a renegade Special Forces Colonel who sees himself as a god.', 'poster_url': 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=800&h=450&fit=crop', 'genres': ['Drama', 'Mystery', 'War'], 'actors': ['Martin Sheen']},
            
            # Stanley Kubrick Films
            {'title': '2001: A Space Odyssey', 'release_year': 1968, 'director': 'Stanley Kubrick', 'rating': 8.3, 'duration': 149, 'plot': 'After uncovering a mysterious artifact buried beneath the Lunar surface, a spacecraft is sent to Jupiter with the sentient computer HAL after discovering an identical object.', 'poster_url': 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=450&fit=crop', 'genres': ['Adventure', 'Sci-Fi'], 'actors': ['Keir Dullea']},
            {'title': 'The Shining', 'release_year': 1980, 'director': 'Stanley Kubrick', 'rating': 8.4, 'duration': 146, 'plot': 'A family heads to an isolated hotel for the winter where a sinister presence influences the father into violence, while his psychic son sees horrific forebodings from both past and future.', 'poster_url': 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1509347528160-9329d33b2588?w=800&h=450&fit=crop', 'genres': ['Drama', 'Horror'], 'actors': ['Jack Nicholson']},
            
            # Alfred Hitchcock Films
            {'title': 'Psycho', 'release_year': 1960, 'director': 'Alfred Hitchcock', 'rating': 8.5, 'duration': 109, 'plot': 'A Phoenix secretary embezzles $40,000 from her employer\'s client, goes on the run, and checks into a remote motel run by a young man under the domination of his mother.', 'poster_url': 'https://images.unsplash.com/photo-1489599735734-79b4af9593ba?w=400&h=600&fit=crop', 'backdrop_url': 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&h=450&fit=crop', 'genres': ['Horror', 'Mystery', 'Thriller'], 'actors': ['Anthony Perkins']},
        ]
